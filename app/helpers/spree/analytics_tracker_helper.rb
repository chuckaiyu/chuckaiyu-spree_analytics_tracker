module Spree
  module AnalyticsTrackerHelper
    ...
    def segment_tracker
      @segment_tracker ||= Spree::AnalyticsTracker.current(:segment, current_store)
    end
    ...
    def ga_tracker
      @ga_tracker ||= Spree::AnalyticsTracker.current(:google_analytics, current_store)
    end
